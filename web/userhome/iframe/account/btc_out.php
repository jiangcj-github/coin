        ...
        <div class="right">
            ...
            <div class="s3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="fee" value="0.0001">
                    <span class="info">手续费由矿工收取，平台不会收取任何费用<a href="#" class="help">帮助</a></span>
                </div>
                <div class="input-group">
                    <label for="ac_pass">资金密码：</label>
                    <input type="text" id="ac_pass" class="password">
                    <span class="info">您设置的资金密码</span>
                </div>
                <div class="input-group">
            ...
            <div class="s22">
                ...
                <div class="para">2.&nbsp;货币的转出是自动的，实际入账时间取决于区块链网络的确认速度，提高转账手续费可加快网络确认。<a href="#">详细</a></div>
