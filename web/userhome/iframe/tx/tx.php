...
<div class="layout">
    <div class="main">
        ...
        <div class="right">
            <div class="head">
                <a href="/web/userhome/iframe/sell/u1_btc.php" class="new">我的交易</a>
            ...
            <div class="s1">
                <table>
                    ...
                    <thead>
                    <tr> <th>时间</th><th>类型</th><th>货币</th><th>价格(CNY)</th><th>数量</th><th>状态</th><th></th></tr>
                    </thead>
                    <tbody>
...
<script>left.activeItem("tx");</script>
<script>
