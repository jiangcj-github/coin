...
province.init=function(){
    var _this=this;
    _this.widges.proSelect.empty();
    for(i=0;i<_this.data.length;i++){
        var name=_this.data[i].provinceName;
        _this.widges.proSelect.append("<option value='"+name+"' data-index='"+i+"'>"+name+"</option>");
    }
    _this.widges.proSelect.change(function(){
        var p=$(this).val();
    ...
    _this.widges.proSelect.val("北京市").trigger("change");
};
province.init();
